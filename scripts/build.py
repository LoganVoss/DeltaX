...
<main>
  ...
  <section class="section">
    ...
    <div class="prose">
      ...
      <p>I'm still not sure if AI music fits into my workflow as a musician, but I'm happy that I was able to contribute a tool for aspiring artists to make their work better.</p>
    </div>
  </section>
</main>
{foot()}
